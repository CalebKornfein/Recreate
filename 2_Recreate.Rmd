...
ggplot(df, aes(x=GMR.Pre, y=GMR.Post, color=Statins, shape=Statins), size = 10) +
      ...
      scale_x_continuous(breaks = c(0, 25, 50, 75, 100, 125, 150, 175),
                         limits = c(0,175)) + 
      geom_abline(intercept = intercept1, slope = slope, color = "deeppink4", size = 0.4, alpha = 0.8) +
      geom_abline(intercept = intercept2, slope = slope, color = "deeppink4", size = 0.4, alpha = 0.8) +
